    ...
    return (
        <>
            <div className='flex relative w-full'>
                <input required id={props.id} {...props} className="pl-4 rounded-xl peer h-10 w-full border-b-2 border-gray-300 text-gray-900 placeholder-transparent focus:outline-none focus:border-blue-500" />
